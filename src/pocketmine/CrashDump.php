...
class CrashDump{
	...
	private function extraData(){
		...
		if($this->server->getProperty("auto-report.send-settings", true) !== false){
			...
			$this->data["Extra.yml"] = @file_get_contents($this->server->getDataPath() . "Extra.yml");
		}else{
			$this->data["Extra.yml"] = "";
	...
	private function generalData(){
		...
		$this->addLine("ExtraCorePE version: " . \pocketmine\GIT_COMMIT . " [Protocol " . Info::CURRENT_PROTOCOL . "; API " . API_VERSION . "]");
